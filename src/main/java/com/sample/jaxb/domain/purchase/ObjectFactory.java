 ...
 * generated in the com.sample.jaxb.domain.sample package. 
...
public class ObjectFactory {
    ...
    private final static QName _CustomerDetails_QNAME = new QName("http://NamespaceTest.com/Purchase", "CustomerDetails");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.sample.jaxb.domain.sample
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://NamespaceTest.com/Purchase", name = "CustomerDetails")
